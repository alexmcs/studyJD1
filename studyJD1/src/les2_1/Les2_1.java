...
в результате у вас должно быть 2-е новых переменных типа String с част€ми
из изначальной строки. ѕолученные строки выведите на экран.
*/
...
public class Les2_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("¬ведите любой текст: ");
		String originMessage = sc.nextLine();
		int originLength = originMessage.length();
		System.out.println("ƒлина строки равна: " + originLength);
